...
def smtp_client_with_image_attachment(from_addr, to_addrs, subject, message, attachment_path):
    server = 'interia.pl'
    port = 587
    ...
    with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as sock:
        ...
        message_data = (
            ...
            f"--{boundary}\r\nContent-Type: image/jpeg; name=\"{attachment_path}\"\r\n"
...
smtp_client_with_image_attachment('pas2017@interia.pl', ['odbiorca@example.com'], 'Test Email', 'Treść wiadomości.',
                                  'obrazek.jpg')

...
def smtp_client_html(from_addr, to_addrs, subject, message):
    server = 'interia.pl'
    port = 587
...
smtp_client_html('pas2017@interia.pl', ['odbiorca@example.com'], 'Test Email',
                 '<b>pogrubienie</b> <i>pochylenie</i> <u>podkreślenie</u>')
